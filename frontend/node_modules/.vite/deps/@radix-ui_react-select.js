...
import {
  usePrevious,
  useSize
} from "./chunk-SPGBK3CJ.js";
import {
  createCollection
} from "./chunk-U4NTGHLO.js";
import {
  clamp
...
import {
  ...
  hideOthers,
  useFocusGuards
} from "./chunk-FYXHYARF.js";
import {
  useId
} from "./chunk-EANFGGEU.js";
import {
  useControllableState
} from "./chunk-HIOYDWEC.js";
import {
  useCallbackRef
...
function createSlotClone3(ownerName) {
  const SlotClone = React8.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React8.isValidElement(children) ? getElementRef3(children) : void 0;
    const ref = useComposedRefs(childrenRef, forwardedRef);
...
function createSlotClone4(ownerName) {
  const SlotClone = React10.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React10.isValidElement(children) ? getElementRef4(children) : void 0;
    const ref = useComposedRefs(childrenRef, forwardedRef);
